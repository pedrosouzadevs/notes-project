  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="overflow-hidden fixed inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[650px] w-full md:h-[70vh] bg-slate-700 md:rounded-md flex flex-col outline-none">
          ...
          <button type="button" onClick={() => onNoteDeleted(note.id)} className="w-full bg-slate-800 py-4 text-center text-sm text-slate-300 outline-none font-medium group">
            <span className='text-red-400 group-hover:underline'>Deseja apagar essa nota?</span>
          </button>
        </Dialog.Content>
      </Dialog.Portal>
    </Dialog.Root>
